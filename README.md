...
## 2. Καταγραφή των Κανόνων

### 2.1 Αριθμητικοί Μετασχηματισμοί
...
### 2.2 Μετασχηματισμοί Κεφαλαίων/Πεζών
